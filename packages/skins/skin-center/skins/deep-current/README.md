...
Deep Current gives the dsh web GUI an oceanographic observatory character: an abyss-green sidebar frames a pearl workspace while quiet bathymetric contours gather around the composer.
...
- **Bathymetric signature**: static contour lines and a soft current band concentrate around the composer without moving beneath message text.
...
The skin follows the GUI light/dark setting automatically and has no skin-specific controls. The Skin Center enable switch and global background controls remain available.
